...
/* AcmeAddressbookBundle:Addressbook:index.html.twig */
class __TwigTemplate_2aba0123e67e3510317433cbe20a49d5 extends Twig_Template
{
    ...
    <a href=\"";
        // line 11
        echo $this->env->getExtension('routing')->getPath("_addressbook_add");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 43
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_addressbook_view", array("id" => $this->getAttribute($this->getContext($context, "user"), "id"))), "html", null, true);
            echo "\">View</a>
                    <a href=\"";
            // line 44
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_addressbook_edit", array("id" => $this->getAttribute($this->getContext($context, "user"), "id"))), "html", null, true);
            echo "\">Edit</a>
                    <a href=\"";
            // line 45
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_addressbook_delete", array("id" => $this->getAttribute($this->getContext($context, "user"), "id"))), "html", null, true);
            echo "\">Delete</a>
                </td>
            </tr>
            ";
...
";
    ...
    {
        return "AcmeAddressbookBundle:Addressbook:index.html.twig";
    }
